...
$saveURL = \Yii::$app->getUrlManager()->createUrl('categories/save');
$deleteURL = \Yii::$app->getUrlManager()->createUrl('categories/delete');
$this->registerJs( <<< EOT_JS
       ...
       function(ev) {   
        ...
        $.post(
            ...
            function(data) {
                alert(data);
                location.href='?r=categories/index';
            }
        )
        ev.preventDefault();
  }); 
...
<div id="addCategories" {{^edit}}class="collapse"{{/edit}}>
     <form action="index.php?r=events/index" method="post" id="frm1">
    <table class="table">
        <tr><td>Category Name<td><input name="name" id="name" value="<?=$name?>" class="form-control" type="text" />
...
<table id="datalisting" class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      ?>
        <tr><td><?=$user['name']?></td><td><td><a href='?actions=edit&id=<?=$user['id']?>&r=call-groups/extensions'><small><i class="glyphicon glyphicon-user"></i></small></a> <a href='?actions=edit&id=<?=$user['id']?>&r=categories/index'><small><i class="glyphicon glyphicon-pencil"></i></small></a> <a href='#' class='delete_event' id='<?=$user['id']?>' event_name='<?=$user['name']?>'><small><i class="glyphicon glyphicon-trash"></i></small></a>  </td>
     <?php
      endforeach;
     ?>
    </tbody>
