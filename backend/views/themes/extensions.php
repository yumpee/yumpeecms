...
$customURL =  \Yii::$app->getUrlManager()->createUrl('themes/fetch-twig-theme');
$saveURL =  \Yii::$app->getUrlManager()->createUrl('themes/save-twig-theme');

$this->registerJs( <<< EOT_JS

$("#theme").change(function(){
        var new_theme=$("#theme").val();
        location.href='?r=themes/extensions&reload=true&theme=' + new_theme;
...
<table id="datalisting" class="table table-bordered table-striped">
    <thead><tr><th>Template<th>Actions</thead>
    <tbody>
      <?php
      ...
      ?>
        <tr><td><font color='green'><?=$user['name']?></font></td><td><a href='#' class='twig_event' id='<?=$user['route']?>' event_name='<?=$user['name']?>' title="Twig" filename="<?=$filename?>"><small><i class="fa fa-file-code-o"></i></small></a> </td>
        <?php
            else:
        ?>
        <tr><td><?=$user['name']?></td><td> <a href='#' class='twig_event' id='<?=$user['route']?>' event_name='<?=$user['name']?>' title="Twig" filename="<?=$filename?>"><small><i class="fa fa-file-code-o"></i></small></a> </td>
     <?php
        endif;
      endforeach;
     ?>
