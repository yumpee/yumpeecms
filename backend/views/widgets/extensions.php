...
$customURL =  \Yii::$app->getUrlManager()->createUrl('widgets/fetch-twig-widget');
$saveURL =  \Yii::$app->getUrlManager()->createUrl('widgets/save-twig-widget');
...
<table id="datalisting" class="table table-bordered table-striped">
    <thead><tr><th>Widget<th>Short Name<th>Actions</thead>
    <tbody>
      <?php
      ...
      ?>
        <tr><td><font color='green'><?=$user['name']?></font></td><td><font color='green'><?=$user['short_name']?></font><td> <a href='#' class='twig_event' id='<?=$user['short_name']?>' event_name='<?=$user['name']." (".$user['short_name'].")"?>' title="Twig" filename="<?=$filename?>"><small><i class="fa fa-file-code-o"></i></small></a> </td>
        <?php
            else:
        ?>
                <tr><td><?=$user['name']?></td><td> <?=$user['short_name']?><td> <a href='#' class='twig_event' id='<?=$user['short_name']?>' event_name='<?=$user['name']." (".$user['short_name'].")"?>' title="Twig" filename="<?=$filename?>"><small><i class="fa fa-file-code-o"></i></small></a> </td>
     <?php
        endif;
      endforeach;
     ?>
