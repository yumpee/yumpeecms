...
<div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Featured Article</h4>
      </div>
        <form id='frmWidget'>
      <div class="modal-body">
        <p>No of records to display <br><input type="text" size='2' maxlength='2' id='widget_limit' name='widget_limit' value="<?=$settings ? $settings->widget_limit:''?>"/></p>
