...
CREATE TABLE `tbl_domains` (
  ...
  `active_stat` char(3) DEFAULT 'Yes',
  `description` text
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `tbl_forms` (
  ...
  `form_fill_limit` bigint(6) NOT NULL,
...
INSERT INTO `tbl_user` (`id`, `username`, `first_name`, `last_name`, `title`, `role_id`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `extension`, `status`, `created_at`, `updated_at`, `display_image_id`, `about`, `no_of_views`, `sort_order`, `rating`) VALUES
(1, 'admin', 'Peter', 'Odon', 'Administrator', 'f2d16e5cedb1c39a8630b775974565', '', '$2y$13$krxMlDgSnaEqfzrS51mRd.4diQioXySM3NeG5PiSO3kyZUcxHZDvi', NULL, 'info@yumpeecms.com', NULL, 10, 0, 1532655302, 'eb4f8864d080684d555b39c3194f1afd2565', 'Peter is a web developer', NULL, NULL, NULL);
